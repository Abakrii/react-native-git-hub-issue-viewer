# GITHUB ISSUE REVIEWR + React Native app example

# This is a mobile application that allows to browse GitHub issues.
...
![alt text](https://github.com/Abakrii/react-native-git-hub-issue-viewer/tree/main/src/core/assets/1.jpg)
...
- React Native Application, for Android/IOS Devices.
- Feature (screen) oriented architecture.
- Component composition pattern.
- State and view of the app are seperated.
...
- [SRC]
  - [CORE]
    ...
    - [CONSTANTS]
  - [FEATURES]
    - [REPO_ISSUE,SCREEN]->COMPONENTS
    - [REPO_SEARCH,SCREEN]->COMPONENTS
  - [NAVIGATIONS]
  - [NETWORK]
  - [STORE]
  - [UTILS]
